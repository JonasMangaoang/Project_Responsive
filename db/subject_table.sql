...
VALUES 
    ...
    (NULL, '2COMPAP', 'Competency Appraisal 2',NULL),
    (NULL, '2CRILAW', 'Criminal Law Book 2',NULL),
    (NULL, '2DATBSE', 'Database Management System 1',NULL),
    (NULL, '2TECHRE', 'Technical Report Writing 2',NULL),
    (NULL, '3DANIM+', '3D ANIMATION',NULL),
    (NULL, '3UP6ONE', 'Physics 1',NULL),
